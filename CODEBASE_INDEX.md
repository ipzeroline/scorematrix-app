...
- Match detail keeps the current score from API `goals` separate from period scores in API `score.halftime`, `score.fulltime`, `score.extratime`, and `score.penalty`; null period scores are not replaced with the current score.
