...
export function RegisterClient() {
      ...
      await registerApp(
        {
          ...
          favoriteTeamId: form.favoriteTeam || undefined,
  ...
  if (success) {
    return (
      <div className="animate-slide-up mx-auto max-w-xl rounded-3xl border border-emerald-300/20 bg-[#0b111d] p-8 text-center shadow-[0_24px_80px_rgba(0,0,0,0.35)]">
        <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl border border-emerald-300/25 bg-emerald-400/10 text-emerald-300">
        ...
        <Link href={`/${locale}/auth/login`}>
          <Button className="mt-6" size="lg" neon>
            {t("login")}
          </Button>
        </Link>
      </div>
  ...
  return (
    <div className="animate-slide-up grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
      <section className="min-w-0">
        <div className="relative mb-3 overflow-hidden rounded-3xl border border-cyan-300/15 bg-[#0b111d] p-4 shadow-[0_18px_54px_rgba(0,0,0,0.24)] sm:mb-5 sm:p-6">
          ...
          <div className="relative flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="hidden w-full grid-cols-3 gap-2 md:grid md:w-[390px]">
              <HeroStat icon={Trophy} label={t("playerTypeCompetitive")} />
              <HeroStat icon={Zap} label={t("playerTypeAnalyst")} />
              <HeroStat icon={ShieldCheck} label={t("requiredDataTerms")} />
            </div>
          </div>
        </div>
        ...
        >
        <FormSection icon={UserPlus} title={t("requiredDataTitle")} tone="cyan">
        {/* Username */}
        <Input
          label={t("username")}
        ...
        <FormSection icon={Trophy} title={t("recommendedDataTitle")} tone="purple">
        ...
        <FormSection icon={Sparkles} title={t("referralCode")} tone="gold">
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">
            {t("language")}
          </label>
        ...
        <FormSection icon={LockKeyhole} title={t("password")} tone="green">
        {/* Password */}
        <div>
          <Input
            label={t("password")}
        ...
        <div className="rounded-2xl border border-cyan-500/15 bg-cyan-500/5 p-4 text-sm font-semibold leading-6 text-gray-300">
          {t("dataUseNote")}
        </div>
        ...
        <div className="grid gap-3">
          <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-white/10 bg-black/20 p-3">
            <input
              ...
              className="mt-1 h-4 w-4 rounded border-gray-700 bg-[#0a0a0f] text-cyan-500 focus:ring-cyan-500/20"
            />
        ...
        {/* Terms checkbox */}
          <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-lime-300/15 bg-lime-300/[0.04] p-3">
            <input
              type="checkbox"
...
function FormSection({
  ...
  const toneClass = {
    ...
    purple: "border-purple-300/15 bg-purple-300/[0.035] text-purple-200",
    gold: "border-amber-300/15 bg-amber-300/[0.035] text-amber-200",
