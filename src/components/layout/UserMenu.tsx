    ...
    return (
      <div className="flex min-w-0 shrink-0 items-center gap-1 sm:gap-2">
        <Link
          ...
          className="inline-flex min-h-10 min-w-[4.7rem] shrink-0 items-center justify-center rounded-lg bg-cyan-500 px-3 text-sm font-bold leading-none text-black transition-colors hover:bg-cyan-400 max-[380px]:min-w-[3.85rem] max-[380px]:px-2 max-[380px]:text-[12px] sm:px-3.5"
        >
