...
export const newsArticles: NewsArticle[] = [
  ...
  {
    id: 'news-005',
    slug: "behind-the-scenes-at-scorematrix",
    title: 'Behind the Scenes at ScoreMatrix',
    summary: 'An exclusive interview with the ScoreMatrix product team about building the ultimate football prediction platform.',
    content: 'In this exclusive feature, we sit down with the ScoreMatrix product team to discuss the platform\'s journey from a weekend project to one of the most popular football prediction apps in Asia.\n\n"What started as a simple idea - helping friends compete on match predictions - has grown into something much bigger," says the founder. The platform now serves over 100,000 active users across 12 leagues worldwide.\n\nThe team shared insights into their development process, including how they handle the massive data processing required for live match updates. "When you have 15 live matches with thousands of users checking scores simultaneously, the infrastructure needs to be robust."\n\nFuture plans include expanding to South American leagues and introducing a fantasy football mode in late 2025.',
    image: '/images/news/behind-scenes.jpg',
    author: 'Alex Chen',
    category: 'feature',
    publishedAt: new Date(Date.now() - 18 * 3600000).toISOString(),
    tags: ['ScoreMatrix', 'Interview', 'Community', 'Product'],
    readTime: 5,
  },
  {
    id: 'news-006',
